...
- Local keys: `yingju-progress-v1`, `yingju-settings-v1`, `yingju-course-rows-v3`, and isolated temporary session key `yingju-daily-session-v3`; legacy daily-session v1/v2 records are discarded.
