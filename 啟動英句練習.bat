...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "$code = [IO.File]::ReadAllText($env:ENGLISHWEB_LAUNCHER, [Text.Encoding]::UTF8); & ([ScriptBlock]::Create($code)) -Mode 'Start' -ProjectDirectory $env:ENGLISHWEB_PROJECT_DIR"
